...
# Model summary (coefficients, p-values, significance)
summary(model)
...
# Install the 'car' package if you don’t have it yet
...
# Check multicollinearity (install if needed)
library(car)
vif(model)

# Installing  ResourceSelection 
